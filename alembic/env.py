...
Supports both sync (SQLite for local dev) and async operations.
"""
import asyncio
import os
import sys
...
from phone_agent.db.models import (  # noqa: F401 - Register models with Base
    CallModel,
    AppointmentModel,
    ContactModel,
    CompanyModel,
...
database_url = os.environ.get("ITF_DATABASE_URL")
if database_url:
